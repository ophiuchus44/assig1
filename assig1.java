...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(discount>0){
		...
		System.out.println("Your discount is " + discount + " Knut(s)");
		System.out.println("###############################################");
		System.out.println("");
		System.out.println("###############################################");
		System.out.println("Your NEW TOTAL comes to " + customerTotal + " Knuts."); 
		System.out.println("###############################################");
		System.out.println("");
	}
...
//				}
			...
			if(customerTotal<=totalPaid){
				if (totalPaid>customerTotal){
					...
					System.out.println("Your change is " + change + " in Knut(s) or:");
...
////////////////////////////////////////////////////////////////////////////
		...
		System.out.println("Check Inventory of Sales?  \n[say: yes, or ya, or ok, or si, or y, or ya dude, or 1]");
...
//		System.out.println(bossCheck);
		...
		if(bossCheck){
			System.out.println("Today's Inventory of Sales:");
			displayBossTotal();
...
//////////////////////////////////////////////////////////////////////
			...
			// maybe could have passed inScan as an argument...
			Scanner inScan = new Scanner(System.in);
...
//		}
		...
		// only display if orders made
			...
			if(quaffleTotal>0){
				...
				System.out.println("Quaffle Box(s) Total: " + quaffleTotalCost+ " Knut(s)");
